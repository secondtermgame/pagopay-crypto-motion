...
- Cryptocurrency-to-fiat conversion services
- Wallet-to-wallet transfers between verified PagoPay users
...
- Not be located in, resident in, or a national of a jurisdiction subject to comprehensive sanctions
- Not be listed on any applicable sanctions or watchlists
...
The Platform currently provides access to the following services:
- Cryptocurrency deposits and conversion to USD
- Wallet-to-wallet transfers between verified PagoPay users
- Prepaid card issuance, funding, and spending
...
Certain services involve fees, including but not limited to:
- Account Setup Fees
- Monthly card maintenance fees
- Cryptocurrency conversion fees (varies by card tier; see the Cardholder Agreement for current rates)
- ATM withdrawal fees
- Card replacement fees

Applicable fees are disclosed within the Platform, on the PagoPay website, and in the Cardholder Agreement prior to completing transactions. By using the Platform, you agree to pay all applicable fees.

PagoPay reserves the right to modify fees from time to time, including offering temporary or permanent promotional rates. Material fee changes will be communicated to users with reasonable advance notice where practicable.

## 7. CARD MAINTENANCE AND RENEWAL FEES

Certain prepaid card products offered through the Platform require a recurring monthly maintenance fee. By activating and using a PagoPay card, the cardholder authorizes PagoPay and its issuing partners to charge applicable monthly maintenance fees in accordance with the Cardholder Agreement.

Monthly maintenance fees may be automatically deducted from the cardholder's available balance. If sufficient funds are not available at the time of deduction, card functionality may be suspended until the applicable fee is paid, in accordance with the procedures set out in the Cardholder Agreement.

Cardholders may close their card account at any time through customer support. Account Setup Fees and monthly maintenance fees are non-refundable, and no refunds will be issued for any unused portion of a billing period unless required by applicable law.
...
- Enable available security features such as two-factor authentication
...
- Notify PagoPay promptly of any changes to contact information
...
- Recipient cryptocurrency addresses
- Recipient account information for wallet-to-wallet transfers
- Transaction amounts
...
## 10. CRYPTOCURRENCY AND BLOCKCHAIN NETWORK RISK
...
- Attempt to bypass or circumvent identity verification procedures
- Process transactions on behalf of third parties without proper authorization
- Trade, transfer, or hold privacy-focused cryptocurrencies or tokens flagged as high-risk by regulatory authorities
- Use bots, scrapers, automated tools, or other unauthorized means to access the Platform
- Resell, sublicense, or commercially exploit the Platform without authorization
- Attempt to reverse engineer, decompile, or otherwise interfere with the Platform's technical infrastructure
- Violate applicable financial regulations, consumer protection laws, or intellectual property rights
...
- Request additional identity verification at any time
- Delay, hold, or block transactions
- Restrict, suspend, or close accounts
- Report transactions or account activity to regulatory authorities, including FINTRAC, as required by law
...
- The Government of Canada (including the Special Economic Measures Act and Justice for Victims of Corrupt Foreign Officials Act)
...
## 15. WALLET-TO-WALLET TRANSFERS AND THIRD-PARTY CRYPTO PAYMENTS

Users may send and receive wallet-to-wallet transfers between verified PagoPay users. All wallet-to-wallet transfers are subject to compliance review, transaction monitoring, and applicable transaction limits.

Users may also receive cryptocurrency transfers from external blockchain wallets, including transfers originating from third parties. All incoming transactions remain subject to compliance review, transaction monitoring, and source-of-funds verification.
...
Accounts that remain inactive for twelve (12) consecutive months may be classified as dormant. PagoPay does not currently charge an inactivity or dormancy fee but reserves the right to introduce one in the future. In that event, users will be notified by email at least thirty (30) days before any inactivity fee is applied.

Users may avoid inactivity classification by logging into their account or conducting a transaction.
...
- Withdraw or spend all remaining balances
- Settle any outstanding fees or obligations
...
If a user closes their account and later applies for a new account, a new Account Setup Fee will apply, as identity re-verification and new card issuance are required.

## 21. REFUND POLICY

Account Setup Fees, monthly maintenance fees, and crypto-to-fiat conversion fees are generally non-refundable except as required by applicable law.
...
- Errors in user-submitted transaction details
- Losses arising from blockchain network conditions
...
Nothing in these Terms limits liability for gross negligence, willful misconduct, fraud, or any liability that cannot be excluded by applicable law.
...
- User's misuse of the Platform
- User's transactions or activities conducted through the Platform
...
**CLASS ACTION WAIVER:** Users agree that any dispute resolution proceedings will be conducted only on an individual basis and not as a plaintiff or class member in any purported class or representative action. The arbitrator may not consolidate more than one person's claims. This waiver is not intended to limit any rights that cannot be waived under applicable consumer protection law, including the Québec Consumer Protection Act.
...
**No Waiver:** PagoPay's failure to enforce any right or provision of these Terms shall not be deemed a waiver of such right or provision.

**Assignment:** Users may not assign or transfer these Terms or their account without the prior written consent of PagoPay. PagoPay may assign these Terms in connection with a merger, acquisition, or sale of assets.

**Entire Agreement:** These Terms, together with the Privacy Policy, the Cardholder Agreement, and any other policies referenced herein, constitute the entire agreement between the user and PagoPay regarding the Platform and supersede all prior agreements and understandings.

**Language:** These Terms are provided in English. A French version may be made available for users in Québec in accordance with applicable language laws. In the event of a conflict between the English and French versions, the version in the user's preferred language shall prevail to the extent permitted by law.
...
- General support: [support@mypagopay.com](mailto:support@mypagopay.com)
- Compliance and complaints: [compliance@mypagopay.com](mailto:compliance@mypagopay.com)
- Privacy inquiries and general information: [info@mypagopay.com](mailto:info@mypagopay.com)

PagoPay Payment Services  
Operated by 9538-8310 Québec Inc.  
FINTRAC Registration: N300000116  
